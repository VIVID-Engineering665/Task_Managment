...
--
-- Host: localhost:3306
-- Generation Time: Apr 29, 2024 at 08:23 PM
...
(1, 1, 1, 'user', 71, 'status', NULL, NULL, 'created', 'Admin System created status  do good', '2024-04-29 17:24:38', '2024-04-29 17:24:38'),
(2, 1, 1, 'user', 1, 'project', NULL, NULL, 'created', 'Admin System created project  helo', '2024-04-29 17:25:01', '2024-04-29 17:25:01'),
(3, 1, 1, 'user', 1, 'project', NULL, NULL, 'deleted', 'Admin System deleted project helo', '2024-04-29 17:25:12', '2024-04-29 17:25:12'),
(4, 1, 1, 'user', 1, 'note', NULL, NULL, 'created', 'Admin System created note  do ggood', '2024-04-29 17:26:47', '2024-04-29 17:26:47'),
(5, 1, 1, 'user', 1, 'note', NULL, NULL, 'deleted', 'Admin System deleted note do ggood', '2024-04-29 17:26:53', '2024-04-29 17:26:53'),
(6, 1, 1, 'user', 71, 'status', NULL, NULL, 'deleted', 'Admin System deleted status do good', '2024-04-29 17:27:28', '2024-04-29 17:27:28'),
(7, 1, 1, 'user', 2, 'note', NULL, NULL, 'created', 'Admin System created note  hello', '2024-04-29 17:27:50', '2024-04-29 17:27:50'),
(8, 1, 1, 'user', 2, 'note', NULL, NULL, 'deleted', 'Admin System deleted note hello', '2024-04-29 17:28:03', '2024-04-29 17:28:03');
...
(5, 'general_settings', '{\"company_title\":\"Task Management System\",\"currency_full_form\":\"Pakistan Rupees\",\"currency_symbol\":\"Rs\",\"currency_code\":\"PKR\",\"currency_symbol_position\":\"before\",\"currency_formate\":\"comma_separated\",\"decimal_points_in_currency\":\"2\",\"timezone\":\"Asia\\/Karachi\",\"date_format\":\"DD-MM-YYYY|d-m-Y\",\"footer_text\":\"<p><a href=\\\"https:\\/\\/www.pakpapertime.com\\/\\\">Pakistan Paper Time<\\/a><\\/p>\",\"full_logo\":\"logos\\/WeMAh7l2NhW1Q4i097k6pfiu1eEfPDKFKKtUI14W.png\",\"half_logo\":\"logos\\/fzNMVlhZxlFhcAJy1boH7d2wZmfzvq3mXTOh9hQ2.png\",\"favicon\":\"logos\\/fdDUZOMxLfkdP35neg5zCxtw0wgjq5suBKceDuXD.png\"}', '2023-06-14 07:48:25', '2024-04-29 18:00:20'),
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `phone`, `email`, `address`, `city`, `state`, `country`, `zip`, `password`, `dob`, `doj`, `photo`, `avatar`, `active_status`, `dark_mode`, `messenger_color`, `lang`, `remember_token`, `email_verified_at`, `created_at`, `updated_at`, `status`) VALUES
(1, 'Admin', 'System', NULL, 'khm.fsd@gmail.com', NULL, NULL, NULL, NULL, NULL, '$2y$10$N057qdWmPIFkEAmY3Ay3gupl91KglYz7EIOQsiu3LZkAxM.SxHp.6', NULL, NULL, 'photos/pQbm8h5ZGlJVBZisejqBqybdAgVK3238YE8EHGDf.png', 'avatar.png', 0, 1, '#2196F3', 'en', NULL, NULL, '2024-04-28 17:35:24', '2024-04-29 10:50:03', 1);
...
(1, '1', 'Default Workspace', '2024-04-28 17:35:24', '2024-04-28 17:35:24');
